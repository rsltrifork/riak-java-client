...
**** Bucket Map Reduce
A BucketMapReduce will run through all keys in the bucket.
This will be time and resource consuming for large datasets.
To create a BucketMapReduce operation call
#+BEGIN_SRC java
